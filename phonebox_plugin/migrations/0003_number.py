    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pbx', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='num_pbx_set', to='phonebox_plugin.pbx')),
                ...
                ('forward_to', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='num_forward_to_set', to='phonebox_plugin.number')),
